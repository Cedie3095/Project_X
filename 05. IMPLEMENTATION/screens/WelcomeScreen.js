...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#Ffc0cb', alignItems: 'center', paddingVertical: 60 },
  ...
  button: { width: 300, height: 50, backgroundColor: '#Ffc0cb', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginTop: 10 },
